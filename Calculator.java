...
public class Calculator extends Frame  {  
    ...
    final int FRAME_WIDTH=325,FRAME_HEIGHT=470;  
    final int HEIGHT=50, WIDTH=30, H_SPACE=10,V_SPACE=10;  
    ...
    Calculator(String frameText){  
        ...
        memLabel.setFont(new Font("Algerian",Font.BOLD,15));
        add(memLabel);  
        ...
        for(int i=0; i<memoryButton.length; i++)  {  
            ...
            memoryButton[i].setFont(new Font("Algerian",Font.BOLD,15));
            y+=HEIGHT+V_SPACE;  
        }  
        ...
        for(int i=0;i<specialButton.length;i++)  {  
            ...
            specialButton[i].setFont(new Font("Algerian",Font.BOLD,12));  
        ...
        for(int i=0;i<digitButton.length;i++)  {  
            ...
            digitButton[i].setFont(new Font("Algerian",Font.BOLD,15));
            tempX+=WIDTH+H_SPACE;  
        if((i+1)%3==0){
    ...
    for(int i=0;i<operatorButton.length;i++)  {  
        ...
        operatorButton[i].setFont(new Font("Algerian",Font.BOLD,15));
        if((i+1)%2==0){
